...
pub(crate) struct State {
    ...
    pub splitter_lock_state_ts: Option<u64>,
    pub splitter_main_continuation_requested: bool,
    pub splitter_main_continuation_timer_pending: bool,
    ...
    pub last_known_ledger_fee_e8s: Option<u64>,
...
impl State {
    pub(crate) fn new(config: Config, now_secs: u64) -> Self {
        Self {
            ...
            splitter_lock_state_ts: Some(0),
            splitter_main_continuation_requested: false,
            splitter_main_continuation_timer_pending: false,
            ...
            last_known_ledger_fee_e8s: None,
            active_job: None,
