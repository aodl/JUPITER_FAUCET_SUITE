...
const privateExportChecks = [
  ['jupiter-faucet-frontend/frontend-src/src/advanced-memo-builder.js', [
    'JUPITER_NEURON_ID_MAX_DIGITS',
    'U64_MAX',
    'isAscii',
  ]],
  ['jupiter-faucet-frontend/frontend-src/src/chart-rendering.js', [
    'toBigIntValue',
    'ratioBigInt',
  ]],
  ['jupiter-faucet-frontend/frontend-src/src/data/index-transactions.js', [
  ...
  ['jupiter-faucet-frontend/frontend-src/src/dashboard-data.js', [
  ...
  ['jupiter-faucet-frontend/frontend-src/src/projection-simulator.js', [
    'SECONDS_PER_DAY',
    'ceilDiv',
    'normaliseSimulatorInputs',
  ]],
  ['jupiter-faucet-frontend/frontend-src/src/tracker-cycles.js', [
